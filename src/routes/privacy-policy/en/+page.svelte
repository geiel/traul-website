<article class="prose p-6 lg:px-32 max-w-none">
	<h1>Dominican Republic Privacy Policy</h1>
	<p>
		This privacy notice for Traul Inc ("we," "us," or "our"), describes how and why we might
		collect, store, use, and/or share ("process") your information when you use our services
		("Services"), such as when you:
	</p>
	<ul>
		<li>
			Download and use our mobile application (Traul), or any other application of ours that links
	...
	<p>
		...
		Services. If you still have any questions or concerns, please contact us at traulapp@gmail.com.
	</p>
	...
	<p>
		<strong
			...
			of contents below to find the section you are looking for.</strong
		>
	</p>
	<p>
	...
	<p>
		<strong>Do we process any sensitive personal information?</strong> We process sensitive personal
		information locally on your device, and this information is not transmitted or stored on any server.
	</p>
	<p>
	...
	<p>
		<strong>Sensitive Information.</strong> We do not process sensitive information on our servers. All
		sensitive data is processed locally on your device and is not transmitted or stored on any server.
	</p>
	<p>
		...
		associated with your payment instrument. All payment data is handled and stored by RevenueCat.
	...
	<ul>
		<li>
			<strong>Mobile Device Access.</strong> We may request access or permission to certain features
			from your mobile device, including your mobile device's storage, and other features. If you wish
		...
		<li>
			...
			mobile device ID, model, and manufacturer), operating system, version information and system configuration
			...
			server). If you are using our application(s), we may also collect information about the phone network
			associated with your mobile device, your mobile device’s operating system or platform, the type
			of mobile device you use, your mobile device’s unique device ID, and information about the features
	...
	<ul>
		...
		<li>
			<strong
				>To evaluate and improve our Services, products, marketing, and your experience.</strong
	...
	<p>
		...
		collected from children under age 18, please contact us at traulapp@gmail.com.
	</p>
	...
	<ul>
		...
		<li>Delete the mobile app, that will remove any local information.</li>
	</ul>
	<p>
	...
	<p>
		If you have questions or comments about this notice, you may email us at traulapp@gmail.com or
		contact us by phone at (849) 855-9867
	</p>
